...
public class Rent__2 implements Parcelable
{
    ...
    public final static Creator<Rent__2> CREATOR = new Creator<Rent__2>() {


        public Rent__2 createFromParcel(android.os.Parcel in) {
            return new Rent__2(in);
        }

        public Rent__2 [] newArray(int size) {
            return (new Rent__2[size]);
        }
    ...
    protected Rent__2(android.os.Parcel in) {
