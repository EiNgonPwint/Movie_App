...
public class Buy__2 implements Parcelable
{
    ...
    public final static Creator<Buy__2> CREATOR = new Creator<Buy__2>() {


        public Buy__2 createFromParcel(android.os.Parcel in) {
            return new Buy__2(in);
        }

        public Buy__2 [] newArray(int size) {
            return (new Buy__2[size]);
        }
    ...
    protected Buy__2(android.os.Parcel in) {
