...
public class Buy__3 implements Parcelable
{
    ...
    public final static Creator<Buy__3> CREATOR = new Creator<Buy__3>() {


        public Buy__3 createFromParcel(android.os.Parcel in) {
            return new Buy__3(in);
        }

        public Buy__3 [] newArray(int size) {
            return (new Buy__3[size]);
        }
    ...
    protected Buy__3(android.os.Parcel in) {
