...
public class Buy__1 implements Parcelable
{
    ...
    public final static Creator<Buy__1> CREATOR = new Creator<Buy__1>() {


        public Buy__1 createFromParcel(android.os.Parcel in) {
            return new Buy__1(in);
        }

        public Buy__1 [] newArray(int size) {
            return (new Buy__1[size]);
        }
    ...
    protected Buy__1(android.os.Parcel in) {
