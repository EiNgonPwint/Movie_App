...
public class Rent__1 implements Parcelable
{
    ...
    public final static Creator<Rent__1> CREATOR = new Creator<Rent__1>() {


        public Rent__1 createFromParcel(android.os.Parcel in) {
            return new Rent__1(in);
        }

        public Rent__1 [] newArray(int size) {
            return (new Rent__1[size]);
        }
    ...
    protected Rent__1(android.os.Parcel in) {
