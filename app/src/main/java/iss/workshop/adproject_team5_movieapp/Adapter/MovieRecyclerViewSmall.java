...
public class MovieRecyclerViewSmall extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovieRecyclerViewSmall(OnMovieClickListener onMovieClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == DISPLAY_SEARCH) {
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.movie_item_small,
                    parent, false);
