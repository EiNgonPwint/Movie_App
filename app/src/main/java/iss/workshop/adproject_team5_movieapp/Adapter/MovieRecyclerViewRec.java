...
public class MovieRecyclerViewRec extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovieRecyclerViewRec(OnMovieClickListener onMovieClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == DISPLAY_SEARCH) {
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rec_movie_item,
                    parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (itemViewType == DISPLAY_SEARCH){
            ...
            Glide.with(holder.itemView.getContext())
                    .load( "https://image.tmdb.org/t/p/w500/"
                            +movieList.get(i).getPosterPath())
                    .into(((RecommendViewHolder)holder).imageView_rec);
